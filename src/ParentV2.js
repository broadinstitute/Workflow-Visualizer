...
class ParentV2 extends Component {
  ...
  addSingleRandomNode () {
    var myCy = this.refs.graph.getCy()
  ...
  //     }).run()
  //   } else {
  //     console.warn('this selection should not be able to happen!')
  //   }
  }
  ...
  componentDidMount () {
    ...
    var refCy = this.refs.graph.getCy()
    refCy.add([
    ...
    return (
      ...
      <div>
        ...
        <div className='flexbox-container'>
          <CytoscapeV2 className="cyto-model" ref="graph" elements={[{ data: { id: 'a', name: 'a' } }]} />
          <DetailedNodeView className="node-view" selectedNode={this.state.tappedNode} changeGraphLayout={this.state.layout}/>
